(async()=>{
  const VERSION="2026.07.26-partner-double-count-v10";
  ...
  const pascalineClassified=pascalineSale+pascaline.bonus+pascaline.packs+pascalineInstall+pascaline.malus;
  if(pascalineClassified!==pascaline.total) throw new Error("Le dossier Pascaline Iacono reste compté deux fois");
